...
export default function KSMontasjeBrannprodukterScreen() {
	...
	const imageContextKey = createImageContextKey('ks-brann-montasje', projectNumber);
	...
	return (
		<FormPage
			title="KS Montasje Brannprodukter"
		...
		>
			...
			<FormSection title="Prosjektinformasjon">
				<FormField label="EMNE *" htmlFor="ksmbp-emne">
					<FormInput id="ksmbp-emne" type="text" value={emne} onChange={(e) => setEmne(e.target.value)} placeholder="F.eks. Branndør" />
				</FormField>
				<FormField label="ELEMENT NAVN/NR. PÅ MONTERT PRODUKT *" htmlFor="ksmbp-element">
					<FormInput id="ksmbp-element" type="text" value={elementNavn} onChange={(e) => setElementNavn(e.target.value)} placeholder="Element navn eller nummer" />
				</FormField>
			</FormSection>
			...
			<FormSection title="Dokumentinformasjon *">
				<FormField label="OPPRETTET AV (TEAM) *" htmlFor="ksmbp-opprettet-av">
					<FormInput id="ksmbp-opprettet-av" type="text" value={opprettetAv} onChange={(e) => setOpprettetAv(e.target.value)} placeholder="Team navn..." />
				</FormField>
				<div style={gridStyle}>
					<FormField label="GODKJENT DATO *" htmlFor="ksmbp-godkjent-dato">
						<FormInput id="ksmbp-godkjent-dato" type="date" value={godkjentDato} onChange={(e) => setGodkjentDato(e.target.value)} />
					</FormField>
					<FormField label="GODKJENT AV *" htmlFor="ksmbp-godkjent-av">
						<FormInput id="ksmbp-godkjent-av" type="text" value={godkjentAv} onChange={(e) => setGodkjentAv(e.target.value)} placeholder="Navn..." />
					</FormField>
				</div>
				<FormField label="VERSJON NR" htmlFor="ksmbp-versjon">
					<FormInput id="ksmbp-versjon" type="text" value={versjonNr} onChange={(e) => setVersjonNr(e.target.value)} placeholder="V1.0" />
				</FormField>
			</FormSection>
				...
				onClick={() =>
					navigate('/image-capture', {
						state: createImageCaptureState({
							...
							contextTitle: 'KS Montasje Brannprodukter',
				...
				onClick={() =>
					navigate('/success', {
						state: createSuccessState({
							formTitle: 'KS Montasje Brannprodukter',
							projectContext: { manualProjectEntry, projectNumber, projectName },
							returnNavigation,
						}),
					})
