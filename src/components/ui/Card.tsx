...
const cardBaseClass = 'bg-card text-card-foreground flex flex-col gap-6 rounded-xl border';
const cardHeaderBaseClass =
...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card" className={cn(cardBaseClass, className)} {...props} />;
}

function CardHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-header" className={cn(cardHeaderBaseClass, className)} {...props} />;
}
...
function CardAction({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-action" className={cn(cardActionBaseClass, className)} {...props} />;
}
